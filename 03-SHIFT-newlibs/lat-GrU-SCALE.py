...
#for intrusion in [0,1.0,2.,10]:
    ...
    for T in np.linspace(300, 900, 61):
...
uranium  2  den=18.740 {intrusion/100.0:6.4f} {T}
        ...
        fout.write(f'''=shell
ln -fs /home/ondrejch/projects/AMPX-myrun/libraries/ce/ce_fplibrary.xml ce_library.xml
ln -s /home/ondrejch/projects/AMPX-myrun/libraries/final-ce .
end
=csas6-shift parm=(   )
